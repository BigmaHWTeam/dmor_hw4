...
greedy schedule results in the same exact production sequence as the optimal schedule with a makespan of 64 hours.
The commercial first schedule results in a different production sequence than the optimal schedule:
\[1 \rightarrow 2 \rightarrow 3 \rightarrow 4 \rightarrow 5\]
with a makespan of 67 hours.
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/problem2_optimal_gantt.pdf}
