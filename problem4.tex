...
\subsection{}
The integer problem can be formulated as:
\begin{center}
  \begin{align*}
...
identified as the optimal solution via the Branch and Bound search with a production schedule of 2 Fuselage Panels,
167 Wing Spars, and 104 Wing Ribs. The output for node 32's model is included as
