...
You will see these prime nodes in the data file are indicates with a suffix of ``p''.
...
The output indicates that the optimal locations when only two crews are at Nodes 8 and 23.
The crew at Node 8 should repair the power stations at Nodes 3, 3p, 6p, and 13.
The crew at Node 23 should repair the power stations at Nodes 23p and 24.
The objective function value for 2 crews is $18.0$.

With the addition of a 3rd crew, the optimal locations for the three crews are at Nodes 3, 6, and 23.
The crew at Node 3 should still repair the power stations at Nodes 3p and 5.
The crew at Node 6 should repair the power station at node 6p.
The crew at Node 23 should repair the power stations at Nodes 13, 23p and 24.
The objective function value is $12.0$.
\begin{tcolorbox}
  \lstinputlisting[numbers=left, numberstyle=\tiny,
    stepnumber=2, numbersep=5pt,
